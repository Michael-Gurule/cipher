...
print(f"\nEmail exposure:")
print(f"  Exposed: {df['exposed_to_email'].sum():,} ({df['exposed_to_email'].mean()*100:.1f}%)")
...
print(f"\nInterpretation:")
print(f"Email marketing increases conversion probability by {results_conversion['ate']*100:.2f} percentage points")
...
print(f"\nInterpretation:")
print(f"Email marketing increases average revenue by ${results_revenue['ate']:.2f} per user")
...
print(f"Email campaign costs: ${total_cost:,.0f} ({n_emails_sent:,} emails × ${cost_per_email})")
...
print("="*60)
print("\nKey Findings:")
print(f"1. Email marketing has a {results_conversion['ate']*100:.2f} percentage point effect on conversion")
